        ...
        <div className="flex flex-col items-end gap-1 shrink-0">
          ...
          {canReserve && !isFull && !isReserved && (
            <button
              ...
              disabled={isPending}
              className={cn(
                'rounded-lg px-3 py-1.5 text-caption font-semibold text-white transition-colors duration-300 disabled:opacity-60',
                isDuoOpen ? 'bg-accent-600 hover:bg-primary-700' : 'bg-primary-700 hover:bg-accent-600'
              )}
            >
