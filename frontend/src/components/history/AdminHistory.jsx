  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-center gap-2">
        <span className="text-caption text-ink-500">Coach :</span>
        <Select
          aria-label="Filtrer par coach"
          onChange={e => setFilter('coachId', e.target.value)}
      ...
      {sessions.length === 0 ? (
        <Card padding="md"><p className="py-6 text-center text-body text-ink-500">Aucune session correspondant aux filtres.</p></Card>
      ) : (
        <motion.ul
              ...
              <Card padding="md">
                <header className="flex flex-wrap items-center gap-2 mb-3">
                  ...
                  <span className="text-caption text-ink-500">
                    · Coach {s.coach.firstName} {s.coach.lastName} · {s.duration} min
                  </span>
                </header>
